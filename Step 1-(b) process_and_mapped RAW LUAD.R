...
write.table(data, "TCGA-LUAD.star_counts_with_Gene_ID.tsv", sep = "\t", quote = FALSE)

write.csv(data, "TCGA-LUAD.star_counts_updated.csv", row.names = TRUE, quote = FALSE)
...
clinical_samples <- read.csv("TCGA-LUAD_clinical.csv", header = FALSE, col.names = "sample")
...
write.csv(final_samples, "TCGA-LUAD_matched_samples.csv", row.names = FALSE, quote = FALSE)
